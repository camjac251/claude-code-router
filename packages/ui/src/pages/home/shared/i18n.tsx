...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "CCR uses the selected file's parent directory as CLAUDE_CONFIG_DIR without reading or modifying the file during inherited applies.": "CCR uses the selected file's parent directory as CLAUDE_CONFIG_DIR without reading or modifying the file during inherited applies.",
  ...
  zh: {
    ...
    text: {
      ...
      "CCR uses the selected file's parent directory as CLAUDE_CONFIG_DIR without reading or modifying the file during inherited applies.": "CCR 将所选文件的父目录用作 CLAUDE_CONFIG_DIR；应用继承配置时，CCR 不会读取或修改该文件。",
      "CLI": "CLI",
      "APP": "APP",
      "CLI & APP": "CLI 和 APP",
      "CLI command": "CLI 命令",
